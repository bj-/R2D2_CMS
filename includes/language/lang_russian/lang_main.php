...
$lang['Car'] = 'Ваша Машина';
$lang['Car_Topic'] = 'Машина:';
$lang['Car_descr'] = 'Если вы хотите получить ответ по ремонту именно вашей машины - указывайте модель, кузов, двигатель и год выпуска.';
...
// Personal Settings
$lang['tooltips'] = 'Всплывающие подсказки';
$lang['tooltips_descr'] = 'В режиме "Дерево" каждая ссылка на пост может иметь всплывающую подсказку с содержанием поста.<br>В зависимости от вашего подключения к интернету стоит выбрать количество символов отображаемых в подсказке для того чтоб не открывать все сообщения подряд и иметь возможность прочитать их сразу.';
$lang['tooltips_descr2'] = 'Если вы подключены по модему или GPRS то стоит оставить небольшое значение - 300-400<br>
На выделенной линии со скоростью 128-256кбит 500-1000<br>
На более быстрых линиях поставте значение 10000<br>
0 - отключит подсказки';

$lang['Forum_Index'] = 'Список форумов %s';

$lang['Post_new_topic'] = 'Начать новую тему';
$lang['Reply_to_topic'] = 'Ответить на тему';
$lang['Reply_with_quote'] = 'Ответить';
...
//
$lang['Registered_users'] = 'Зарегистрированные: ';
$lang['Browsing_forum'] = 'Сейчас этот форум просматривают:';
$lang['Online_users_zero_total'] = '';
$lang['Online_users_total'] = '';
$lang['Online_user_total'] = '';
$lang['Reg_users_zero_total'] = '';
$lang['Reg_users_total'] = '';
$lang['Reg_user_total'] = '';
...
$lang['Error_login_fuck'] = 'Я тебя не знаю и знать не хочу. Уходи.';
...
$lang['Empty_subject'] = 'Вы должны указать заголовок сообщения';
$lang['Subject_descr'] = 'Старайтесь в заголовке максимально полно описать суть сообщения.';
...
$lang['bbcode_r_help'] = 'Вставить исходное сообщение';
$lang['bbcode_t_help'] = 'Вставить таблицу. Разделители таблицы должны соответствовать параметру \"separate\", а ограничители текста параметру \"text_qualifier\"';
...
$lang['Avatar_show'] = 'Показывать аватары в форуме';
$lang['Avatar_show_descr'] = 'Вы можете отключить показ аватар в форуме для себя, при этом ваша аватара будет показываться другим пользователям.';


$lang['Website'] = 'Сайт';
$lang['Location'] = 'Откуда';
$lang['Location_descr'] = 'Если вы задаете вопрос актуальный только в этом городе, то указав ваше место нахождения вам не потребуется искать на карте города несуществующие улицы.';
$lang['Contact'] = 'Способы связи с'; // Как связаться с Vasya_Poopkin
...
$lang['Always_view_avatar'] = 'Показывать аватары пользователей';
$lang['Always_tree'] = 'Вид конференции';
$lang['Always_tree_on'] = 'В виде дерева';
$lang['Always_tree_off'] = 'Плоский';
...
$lang['Account_inactive'] = 'Учётная запись была создана. На этом форуме требуется активизация учётной записи<br>
Для активизации введите пожалуйста цифровой код:<br>
<form action="%ACT_URL%&u=%UID%" method="post"><div align="center"><table border="0" cellspacing="10" cellpadding="0"><tr><td><img src="/includes/showcode.php?u=%UID%&sid=%SID%"></td><td>Введите код: <input type="text" name="act_key_short" size="10" maxlength="8"></td></tr>
<tr><td colspan="2"><input type="submit" name="submit_key" value="Активировать запись!"></td></tr></table></div></form>
Либо вы можете активировать свою учетную запись позднее, для этого вам выслан ключ для активизации на введённый вами адрес. Проверьте свою почту для более подробной информации.';
...
$lang['Reg_agreement'] = '
Основное правило - соблюдайте правила хорошего тона и люди к вам потянутся.<br><br>
При продаже запчастей или машин - обязательно указывайте город, телефон и стоимость.<br><br> 
Всегда присушивайтесь модераторов, если они делают вам замечание. Терпение у них хорошее, но отключают они раз и навсегда.<br><br> 
<strong>Перед регистрацией <a href="http://boards.bmworg.ru/ftopic3.php" target="_blank">настоятельно рекомендуется прочитать правила</a></strong>. Несоблюдение их наказывается очень строго.<br>
<h1>А ПРАВИЛА ТАКИ ПРОЧИТАТЬ!</h1><br>
<small>Эти форумы используют cookies для хранения информации на вашем компьютере. Эти cookie не содержат никакой информации из введённой вами и служат лишь для улучшения качества работы форумов. Ваш e-mail адрес используется лишь для подтверждения вашей регистрации и пароля (и для высылки нового пароля если вы забудете текущий).</small>';

$lang['Agree_under_13'] = 'Я согласен с этими условиями';
...
$lang['datetime']['d1'] = $lang['datetime']['Monday'];
$lang['datetime']['d2'] = $lang['datetime']['Tuesday'];
$lang['datetime']['d3'] = $lang['datetime']['Wednesday'];
$lang['datetime']['d4'] = $lang['datetime']['Thursday'];
$lang['datetime']['d5'] = $lang['datetime']['Friday'];
$lang['datetime']['d6'] = $lang['datetime']['Saturday'];
$lang['datetime']['d7'] = $lang['datetime']['Sunday'];
...
//
// Moderators/Awards part
$lang['User_Awards'] = 'Награды пользователя за нарушение правил конференций';
$lang["Award_Currents"] = 'Действующие';
$lang["Award_Expired"] = 'Окончившие действие';
$lang["Award_dates"] = 'Срок действия';
$lang["Award_Type"] = 'Награда';
$lang["Award_Comment"] = 'Коментарий';
$lang["Award_date_from"] = 'с';
$lang["Award_date_to"] = 'по';


// User properties
$lang["Real_Name"] = "Фамилия, имя";
$lang["birth_day"] = "День рожденья";
$lang["last_visit"] = "последний раз заходил";
$lang["only_reg_no_visit"] = "только зарегистрировался и никогда не заходил";
$lang['Phone'] = "Телефоны";
$lang['Phone_Mobile'] = "Мобильный";
$lang['Phone_Work'] = "Рабочий";
$lang['Phone_Home'] = "Домашний";

// Lastvisit
$lang['1_min'] = "минуту назад";
$lang['sev_min'] = "несколько минут назад";
$lang['1_hour'] = "в течение часа";
$lang['1_day'] = "в течение суток";
$lang['sev_days'] = "несколько дней назад";
$lang['sev_week'] = "пару недель назад";
$lang['sev_month'] = "месяц-два назад";
$lang['more_2_month'] = "более 2-х месяцев назад";
$lang['more_6_month'] = "более полугода назад";
// $lang[""] = ;
