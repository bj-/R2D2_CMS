...
<!--tr><td>Форма обратной связи:</td><td>E-Mail: <input type="text" name="form_email" value="{FORM_EMAIL}"> Тема сообщения: <input type="text" name="form_subject" value="{FORM_SUBJECT}" size="49">
<br><small>Если указан E-Mail - внизу статьи будет добавлена форма обратной связи.</small></td></tr-->
<!-- END switch_article_edit -->
...
<tr><td>Фото:</td><td><div id="article_img">{PAGE_PHOTO}{PAGE_PHOTO_EXIST}</div>
...
<small>Загрузить фотографию</small></td></tr>
<!-- END switch_news_edit -->
