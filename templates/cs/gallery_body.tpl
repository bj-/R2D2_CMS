...
<div id="divGalleryPage">
	...
	<div class="gallery-cat" style="box-shadow: 0px 0px 8px #ccc;">
...
<!-- BEGIN gallery_img_list -->
	...
	<div class="thumbwrapper" style="display:table-cell; text-align:center; vertical-align:middle; height:135px; width:175px; background-color:#FFFFFF; border:none;">
		<div class="gallery-cat-edit">
...
<img style="box-shadow:0px 0px 6px #aaaaaa;" src="{switch_gallery.gallery_img_list.SMALL_IMG_PATH}" alt="{switch_gallery.gallery_img_list.IMG_NAME}" title="{switch_gallery.gallery_img_list.IMG_NAME}" /></a>
	<!--/td></tr></table-->
...
<!-- BEGIN switch_video_gallery -->
	...
	<div style="float:left; padding:10px; position:relative; width:130px; height:150px; overflow:hidden;">
		<div style="position:absolute; right:0px; top:0px;">
			{switch_video_gallery.gallery_video_list.DEL_ITEM}
		</div>
		<a href="http://www.youtube.com/embed/{switch_video_gallery.gallery_video_list.VIDEO_ID}?rel=0&amp;wmode=transparent" 
		        ...
		        class="highslide">
			<img src="{switch_video_gallery.gallery_video_list.VIDEO_THUMB}" /><br />
		   <div style="text-align:center; width:100%;">
				{switch_video_gallery.gallery_video_list.VIDEO_NAME}
			</div>
		</a>
	</div>
...
<!-- END gallery_video_list -->
<div style="clear:both"></div>
<!-- END switch_video_gallery_mosaic -->
