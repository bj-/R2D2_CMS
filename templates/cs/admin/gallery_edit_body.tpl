...
function parse_yt_video(input_id, div_id){
	...
	show_content('/admin/gallery/dynamic/adm_dyn_parse_video.php?id={PAGE_ID}&type='+div_id+'&url='+video_url, '#'+div_id);
};
	</script>
		<p></p>
	...
	<tr>
		...
		<td rowspan="2">
			<a href="http://www.youtube.com/embed/{swich_gallery_video_edit_list.gallery_video.VIDEO_ID}?rel=0&amp;wmode=transparent" 
				...
				preserveContent: false, objectLoadTime: 'after'})"
		        class="highslide">
			<img src="{swich_gallery_video_edit_list.gallery_video.VIDEO_THUMB}" />
			</a>
		</td>
	</tr>
<tr>
